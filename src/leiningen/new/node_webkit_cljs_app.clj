...
(defn node-webkit-cljs-app
  ...
  (let [data {:name name
    ...
    (->files data
			 ...
			 ["{{name}}/resources/scripts/jquery-1.9.1.js" (render "app/jquery-1.9.1.js")]
			 ["{{name}}/resources/scripts/jquery-1.9.1.min.js" (render "app/jquery-1.9.1.min.js")]
			 ["{{name}}/resources/scripts/jquery-1.9.1.min.map" (render "app/jquery-1.9.min.map")]
			 ["{{name}}/externs/jquery-1-9.externs.js" (render "app/jquery-1.9.externs.js")]
